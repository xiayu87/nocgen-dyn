...
# NoC
#
system("NOCGEN/noc_test_gen.pl $data_width $array_size $vch_num $topology_type $traffic_ptn $packet_len $packet_num $routing_type > $noc_test_v");
system("NOCGEN/noc_gen.pl $array_size $topology_type $routing_type > $noc_v");

#
# Router
#
system("NOCGEN/router_gen.pl  $port_num $vch_num $routing_type > $router_v");
...
system("NOCGEN/rtcomp_gen.pl  $array_size $topology_type $routing_type $port_num         > $rtcomp_v");
